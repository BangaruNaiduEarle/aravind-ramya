...
import { MapPin, Phone, Mail, Car, Bus, Plane } from 'lucide-react';
    ...
    <section className="py-20 px-4 md:px-8 bg-gray-50">
      ...
      >
        <motion.div variants={itemVariants} className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Venue Location</h2>
          <div className="w-24 h-1 bg-gray-400 mx-auto"></div>
          <p className="mt-6 text-gray-700 max-w-3xl mx-auto">
          All wedding events will take place at the <b>Thandra Paparayudu Function Hall</b>, Pendurthi, a spacious and elegant venue surrounded by a warm and welcoming atmosphere.
          </p>
        </motion.div>
