    ...
    <section className="py-20 px-4 md:px-8 bg-green-50">
      ...
      >
        <motion.div variants={itemVariants} className="text-center mb-12">
          ...
          <b>Tharun</b> and <b>Sharmila’s</b> Paradie ceremony is a special ritual that brings spiritual blessings before their wedding. This tradition purifies their hearts and prepares them for a beautiful life together with the love and support of family and elders. 😊💖
          </p>
        </motion.div>
